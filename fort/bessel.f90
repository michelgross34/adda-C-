!=========================================================
!  Portable C interface for bjndd
!  Compatible: gfortran, ifx, Linux, Windows
!=========================================================

!DEC$ ATTRIBUTES DLLEXPORT :: bjndd
subroutine bjndd(n, x, bj, dj, fj) bind(C, name="bjndd_")
...
! IMPORTANT :
!  - PAS de "value" → compatible avec appel C par pointeurs
!  - Types ISO C garantissent ABI stable

    integer(C_INT),  intent(in)  :: n
    real(C_DOUBLE),  intent(in)  :: x
    real(C_DOUBLE),  intent(out) :: bj(*)
    real(C_DOUBLE),  intent(out) :: dj(*)
    real(C_DOUBLE),  intent(out) :: fj(*)
