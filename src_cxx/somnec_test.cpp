...
double norm2(const double__complex a1,const double__complex a2,const double__complex a3,const double__complex a4)
...
double RelError(const double__complex a1,const double__complex a2,const double__complex a3,const double__complex a4,
	const double__complex b1,const double__complex b2,const double__complex b3,const double__complex b4)
...
int main(int argc,char **argv)
{
	double mre,mim;
	double rho,Z;
	double__complex eps,erv0,ezv0,erh0,eph0,erv1,ezv1,erh1,eph1,erv2,ezv2,erh2,eph2,erv3,ezv3,erh3,eph3;
	SYSTEM_TIME t1,t2;
