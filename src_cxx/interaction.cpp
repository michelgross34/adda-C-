...
extern double ZsumShift;
// defined and initialized in param.c
extern double igt_lim,igt_eps,nloc_Rp;
// extern bool InteractionRealArgs;
...
extern "C" void propaespacelibreintadda_ (const double *Rij,const double *ka,const double *gridspacex,const double *gridspacey,
