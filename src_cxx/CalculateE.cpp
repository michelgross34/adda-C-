...
extern double dtheta_deg,dtheta_rad;
...
extern double ezLab[3],exSP[3];
// defined and initialized in GenerateB.c
extern double C0dipole,C0dipole_refl;
extern int vorticity;
// defined and initialized in param.c
extern bool store_int_field,store_dip_pol,store_beam,store_scat_grid,calc_Cext,calc_Cabs,
